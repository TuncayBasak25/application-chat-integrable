...
class FormView
{
  ...
  {
    ?>
    <form id="login_input_form" onsubmit="ajaxFormSubmit(this)" method="post"></form>
  ...
  {
    ?>
    <form id="message_input_form" onsubmit="ajaxFormSubmit(this); setEmptyInputValue('message_input');" method="post"></form>
